...
我在 [AI 编程 Skills 选型清单](/ai-coding/practices/programmer-essential-skills.html) 和 [强模型时代，AI 编程 Skills 还有必要装吗？](/ai-coding/practices/skill-selection-and-pruning.html) 这两篇文章中，都提到了 [mattpocock/skills](https://github.com/mattpocock/skills)，`grilling` 还专门拿了实际项目举例。
...
![grilling Skill 的完整访谈规则](https://oss.javaguide.cn/github/offerkit/ai/skills/grilling-skill-content.png)
...
![grill-with-docs Skill 的调用关系](https://oss.javaguide.cn/github/offerkit/ai/skills/grill-with-docs-skill-content.png)

![domain-modeling Skill 的领域建模规则](https://oss.javaguide.cn/github/offerkit/ai/skills/domain-modeling-skill-content.png)
...
这次真实使用来自我的开源项目 [SpringAI 智能面试平台](/zhuanlan/interview-guide.html)。
...
![research Skill 的资料检索和结果保存规则](https://oss.javaguide.cn/github/offerkit/ai/skills/research-skill-content.png)
...
![diagnosing-bugs Skill 的 Bug 诊断流程](https://oss.javaguide.cn/github/offerkit/ai/skills/diagnosing-bugs-skill-content.png)
...
![code-review Skill 的双轴代码审查流程](https://oss.javaguide.cn/github/offerkit/ai/skills/code-review-skill-content.png)
...
![Codex 使用 skill-installer 安装 mattpocock skills](https://oss.javaguide.cn/github/offerkit/ai/skills/codex-install-mattpocock-skills.png)
