...
![Boris Cherny 提到 Claude Code 团队喜欢 Ghostty](https://oss.javaguide.cn/github/offerkit/ai/coding/boris-ghostty-x.png)
...
![Ghostty 官网首页](https://oss.javaguide.cn/github/offerkit/ai/coding/ghostty-homepage.png)
...
![Ghostty 版本检查输出](https://oss.javaguide.cn/github/offerkit/ai/coding/ghostty-version.png)
...
![Ghostty 配合 Catppuccin Mocha、JetBrainsMono Nerd Font 和 Starship 的效果](https://oss.javaguide.cn/github/offerkit/ai/coding/ghostty-terminal-demo.png)
...
![Starship explain 展示 prompt 中的路径、分支和 Git 状态](https://oss.javaguide.cn/github/offerkit/ai/coding/starship-explain.png)
...
![Ghostty 分屏运行 Claude Code、开发服务和日志](https://oss.javaguide.cn/github/offerkit/ai/coding/ghostty-split-claude-code.png)
