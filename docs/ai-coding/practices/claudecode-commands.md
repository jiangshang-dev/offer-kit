...
![直接运行 /simplify 命令](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/simplify-command-run.png)

![扫描到的问题](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/simplify-issues-found.png)
...
![开启优化](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/simplify-optimization-start.png)

![所有修改完成](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/simplify-all-fixes-done.png)
...
![直接审查具体的类](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/simplify-class-review.png)
...
![Claude Code 运行 /batch 命令](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/claudecode-batch-run.png)
...
![Claude Code 合并改动](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode/claudecode-batch-create-pr.png)
...
![MiniMax Key 获取](https://oss.javaguide.cn/github/offerkit/ai/coding/minimax-key.png)

![GLM Key 获取](https://oss.javaguide.cn/github/offerkit/ai/coding/glm-key.png)
...
![CC Switch 配置 MiniMax/GLM API Key](https://oss.javaguide.cn/github/offerkit/ai/coding/cc-switch-add-provider.png)

![CC Switch 配置模型](https://oss.javaguide.cn/github/offerkit/ai/coding/cc-switch-model-config.png)

### 3. 验证是否生效

在任意目录下输入 `claude` 命令即可启动 Claude Code，选择**信任此文件夹（Trust This Folder）**。

![验证是否生效](https://oss.javaguide.cn/github/offerkit/ai/coding/claude-code-trust-folder.png)
