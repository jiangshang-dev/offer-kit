...
![DeepSeek 创建 API Key](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-api-keys.png)
...
![CC Switch 主界面](https://oss.javaguide.cn/github/offerkit/ai/coding/cc-switch-main-interface.png)

启动 CC Switch，点击右上角 **"+"** ，选择自定义供应商，Base URL 填写 `https://api.deepseek.com/anthropic`，API Key 填写你的 DeepSeek API Key。

![CC Switch 添加 DeepSeek Provider](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/cc-switch-add-deepseek-provider.png)
...
![验证是否生效](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/verify-deepseek-v4-ready.png)
...
![搜索并更新最新 LLM 模型](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/search-and-update-latest-models.png)
...
![编辑 DeepSeek 模型配置](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/edit-deepseek-model-config.png)
...
![技能管理界面报错](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/skill-management-error.png)
...
![数据库表未执行原因分析](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/database-table-analysis.png)
...
![DeepSeek 完成 Flyway 集成后的总结](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/deepseek-flyway-integration-summary.png)
...
![将面试平台的模型切换到 deepseek-v4-flash](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/interview-guide-model-deepseek-v4-flash.png)

然后上传一份简历，基于这份简历生成一次模拟面试，来看看效果。

面试题是通过 deepseek-v4-flash 生成的，答案也是让 DeepSeek 在快速非思考模式下给出的（有两个问题没有回答）。

![模拟面试评估结果](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/interview-guide-model-deepseek-v4-flash-interview.png)
...
![DeepSeek V4-Pro 扫描分析代码](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/deepseek-v4-pro-scan-analyze-code.png)
...
![GPT5.5 对 DeepSeek V4-Pro 找出的问题进行修复](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/gpt5-5-fix-problems-found-by-deepseek-v4-pro.png)
...
![让 V4-Pro 扫描分析 agent-invest](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/claudecode-deepseek-v4-pro%5B1m%5D.png)

![V4-Pro 扫描分析 agent-invest 的结果](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/v4-pro-scan-analyze-result-of-agent-invest.png)

这是 V4-Pro 最终输出的文档，覆盖了项目结构、主要模块和待处理问题：

![V4-Pro 最终输出的 agent-invest 文档](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/v4-pro-final-output-agent-invest-document.png)
...
![V4 Benchmark 数据](https://oss.javaguide.cn/github/offerkit/ai/coding/deepseek-v4/v4-benchmark.png)
