...
![Subagents 和 Agent Teams 对比](https://oss.javaguide.cn/github/offerkit/ai/coding/claude-code-subagents-vs-agent-teams.png)
...
![Claude Code Explore Subagent：支线搜索在后台执行](https://oss.javaguide.cn/github/offerkit/ai/coding/claude-code-explore-subagent-demo.png)
...
![Claude Code Fork：基于当前上下文启动后台分支](https://oss.javaguide.cn/github/offerkit/ai/coding/claude-code-fork-subagent-demo.png)
...
![Claude Code Agent Teams：多个 teammate 围绕完整分析链路协作审查](https://oss.javaguide.cn/github/offerkit/ai/coding/claude-code-agent-teams-agentinvest-review.png)
...
![工具调用安全风险分层：按风险等级匹配不同的控制策略](https://oss.javaguide.cn/github/offerkit/ai/llm/structured-output-function-calling-tool-call-security.png)
...
延伸阅读可以看 [AIGuide：AI 应用开发、AI 编程实战与面试指南](https://mp.weixin.qq.com/s/le3RzJsaAH22auUoB05y1Q) 的 [上下文工程实战指南](/ai/agent/context-engineering.html) 和 [Spec Coding 规范驱动编程](/ai-coding/practices/spec-coding.html)，前者更偏上下文隔离，后者更偏多代理协作流水线。
