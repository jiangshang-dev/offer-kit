...
![Claude Code、Skills 与上下文工程面试题记录](https://oss.javaguide.cn/github/offerkit/ai/claude-code/claude-code-context-management-interview-questions.png)
...
![Claude Code 架构全景](https://oss.javaguide.cn/github/offerkit/ai/claude-code/ctx-mgmt-arch-arch.png)
...
![上下文窗口（Context Window）= LLM 的工作记忆](https://oss.javaguide.cn/github/offerkit/ai/llm/llm-context-window.png)
...
![Claude Code /context 命令运行结果](https://oss.javaguide.cn/github/offerkit/ai/skills/claude-code-context-command-result.png)
...
![社区经验中的上下文利用率管理线](https://oss.javaguide.cn/github/offerkit/ai/harness/context-utilization-40-percent-threshold-phenomenon.svg)
...
![context-anxiety-harness-design-long-running-apps](https://oss.javaguide.cn/github/offerkit/ai/claude-code/context-anxiety-harness-design-long-running-apps.png)
...
![五级渐进压缩流水线](https://oss.javaguide.cn/github/offerkit/ai/claude-code/ctx-mgmt-pipeline-flow.png)
...
![AutoCompact 压缩前后对比](https://oss.javaguide.cn/github/offerkit/ai/claude-code/ctx-mgmt-compare.png)
...
![上下文重置交接流程](https://oss.javaguide.cn/github/offerkit/ai/claude-code/ctx-mgmt-reset-flow.png)
...
![Claude Code Sub-Agent：让主对话保持干净](https://oss.javaguide.cn/github/offerkit/ai/coding/claudecode-sub-agent.png)
...
![Anthropic 三智能体架构](https://oss.javaguide.cn/github/offerkit/ai/claude-code/ctx-mgmt-triagent-arch.png)
...
`/compact`、Sub-agent、`/context` 的命令细节，可以看之前的 [Claude Code 使用指南](/ai-coding/claudecode-tips.html "Claude Code 使用指南") 和 [Claude Code 核心命令详解](/ai-coding/claudecode-commands.html "Claude Code 核心命令详解")。
