...
🐛 修正（参见 [issue#1915](https://github.com/jiangshang-dev/offerkit/issues/1915)）：
...
![TCP 与 UDP 的消息边界](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-udp-byte-stream-tcp-udp-message-boundary.png)
...
![TCP 粘包 / 拆包为什么会出现？](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-udp-byte-stream-tcp-sticky-split-causes.png)
...
![应用层如何定义消息边界？](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-udp-byte-stream-tcp-message-boundary-solutions.png)
...
![不同 HTTP 版本里，Keep-Alive 的默认行为不一样](https://oss.javaguide.cn/github/offerkit/cs-basics/network/different-http-versions-have-different-default-keep-alive-behaviors.png)
...
![TCP Keepalive 工作原理](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-keepalive-vs-http-keepalive-tcp-keepalive-working-principle.png)

![TCP Keepalive 探测机制](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-keepalive-vs-http-keepalive-tcp-keepalive-detection-mechanism.png)
...
![内核协议分发流程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/can-tcp-and-udp-use-the-same-port-kernel-protocol-dispatching-process.png)
...
![DNS 和 HTTP/3 同时使用 TCP 与 UDP 端口的实际案例](https://oss.javaguide.cn/github/offerkit/cs-basics/network/can-tcp-and-udp-use-the-same-port-practical-application-example.png)
...
![TCP 连接靠四元组区分和真正的限制](https://oss.javaguide.cn/github/offerkit/cs-basics/network/maximum-number-of-tcp-connections-per-host-tcp-four-tuple-and-server-connection.png)
...
![IP 地址使数据包到达其目的地](https://oss.javaguide.cn/github/offerkit/cs-basics/network/internet_protocol_ip_address_diagram.png)
...
![IPv4 地址使用点分十进制格式表示 32 位地址](https://oss.javaguide.cn/github/offerkit/cs-basics/network/Figure-1-IPv4Addressformatwithdotteddecimalnotation-29c824f6a451d48d8c27759799f0c995.png)
...
![IPv6 地址使用十六进制冒号分隔格式表示 128 位地址](https://oss.javaguide.cn/github/offerkit/cs-basics/network/Figure-2-IPv6Addressformatwithhexadecimalnotation-7da3a419bd81627a9b2cef3b0efb4940.png)
...
![NAT 实现 IP地址转换](https://oss.javaguide.cn/github/offerkit/cs-basics/network/network-address-translation.png)
...
![路由器的背面就会注明 MAC 位址](https://oss.javaguide.cn/github/offerkit/cs-basics/network/router-back-will-indicate-mac-address.png)
