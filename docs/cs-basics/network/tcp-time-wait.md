...
![TIME_WAIT 与 CLOSE_WAIT 问题的排查流程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-time-wait-close-wait-troubleshooting-flowchart.png)
...
![macOS：查看各 TCP 状态数量和 TIME-WAIT 主要集中在哪些远端](https://oss.javaguide.cn/github/offerkit/cs-basics/network/macos-check-tcp-state-count-and-time-wait-remote-distribution.png)
