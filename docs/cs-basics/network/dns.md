...
![Root-Servers.org 展示全球根服务器实例分布](https://oss.javaguide.cn/github/offerkit/cs-basics/network/root-servers-org.png)
...
![DNS 递归查询与迭代查询结合的解析流程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/DNS-process.png)
...
![DNS 递归查询解析域名的流程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/DNS-process2.png)
...
![DNS 查询报文和回答报文的字段格式](https://oss.javaguide.cn/github/offerkit/cs-basics/network/DNS-packet.png)
...
![DNS 资源记录的四元组字段](https://oss.javaguide.cn/github/offerkit/cs-basics/network/20210506174303797.png)

`TTL` 是该记录的生存时间，它决定了资源记录应当从缓存中删除的时间。

`Name` 和 `Value` 字段的取值取决于 `Type`：

![不同 DNS 资源记录类型的 Name 和 Value 含义](https://oss.javaguide.cn/github/offerkit/cs-basics/network/20210506170307897.png)
