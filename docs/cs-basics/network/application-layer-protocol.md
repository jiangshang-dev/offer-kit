...
![HTTP：超文本传输协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/http-overview.png)
...
![HTTP 协议](https://oss.javaguide.cn/github/offerkit/450px-HTTP-Header.png)
...
![WebSocket：全双工通信协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/websocket-overview.png)
...
![SMTP：简单邮件传输协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/smtp-overview.png)
...
![SMTP 协议](https://oss.javaguide.cn/github/offerkit/cs-basics/network/what-is-smtp.png)
...
![POP3/IMAP：邮件接收协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/pop3-imap-overview.png)
...
![FTP：文件传输协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/ftp-overview.png)
...
![FTP 工作过程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/ftp.png)
...
![Telnet：远程登录协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/telnet-overview.png)

用户名、密码、命令内容和返回结果都不会加密，攻击者如果能监听网络流量，就可能直接看到敏感信息。

![Telnet：远程登录协议](https://oss.javaguide.cn/github/offerkit/cs-basics/network/Telnet_is_vulnerable_to_eavesdropping-2.png)
...
![SSH：安全的网络传输协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/ssh-overview.png)
...
![SSH：安全的网络传输协议](https://oss.javaguide.cn/github/offerkit/cs-basics/network/ssh-client-server.png)
...
![RTP：实时传输协议概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/rtp-overview.png)
...
![DNS：域名系统概览](https://oss.javaguide.cn/github/offerkit/cs-basics/network/dns-overview.png)
