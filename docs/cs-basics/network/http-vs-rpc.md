...
![RPC 通过本地代理隐藏远程调用细节](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/rpc-overview.png)
...
![Dubbo3 使用 Triple 协议同时支持 HTTP/1、HTTP/2 和 HTTP/3](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/image-20220716111545343.png)
...
![gRPC over HTTP2 基于 HTTP2 的 gRPC 协议](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/grpc-over-http2-github.png)
