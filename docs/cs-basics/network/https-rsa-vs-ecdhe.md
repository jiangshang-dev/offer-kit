...
![RSA 与 ECDHE 密钥交换：核心差异](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-rsa-and-ecdhe-key-exchange-core-differences.png)
...
![静态 RSA 缺少前向安全：完整抓包 + 私钥泄漏可回溯历史流量](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-static-rsa-lacks-forward-secrecy.png)
...
![TLS 1.2 使用 ECDHE RSA 完成握手和密钥协商](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-tls-1-2-ecdhe-rsa-handshake-process.png)
...
![密码套件名拆解](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-cipher-suite-name-decomposition.png)
...
![ECDHE 前向安全原理：长期密钥 vs 临时密钥](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-ecdhe-forward-secrecy-principle-long-term-key-vs-ephemeral-key.png)
...
![TLS 1.2 vs TLS 1.3 握手 RTT 对比](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-tls-1-2-vs-tls-1-3-handshake-rtt-comparison.png)
...
![RSA vs ECDHE 对比速查](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-rsa-vs-ecdhe-quick-reference.png)
