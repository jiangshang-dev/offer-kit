...
![ICMP 和 TCP 位于 TCP/IP 协议栈的不同层次](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-ip-4-model.png)
...
![TLS 1.2 ECDHE 握手流程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/https-rsa-ecdhe-tls-1-2-ecdhe-rsa-handshake-process.png)
