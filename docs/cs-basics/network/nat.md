...
![NAT 将内网私有地址转换为公网地址的过程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/nat-demo.png)
...
![LAN-WAN 间通信提供地址转换](https://oss.javaguide.cn/github/offerkit/cs-basics/network/nat-demo2.png)

🐛 修正（参见：[issue#2009](https://github.com/jiangshang-dev/offerkit/issues/2009)）：上图第四步的 Dest 值应该为 `10.0.0.1:3345` 而不是~~`138.76.29.7:5001`~~，这里笔误了。
