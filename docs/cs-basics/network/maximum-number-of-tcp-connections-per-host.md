...
![客户端直连和 NAT 网关瓶颈](https://oss.javaguide.cn/github/offerkit/cs-basics/network/maximum-number-of-tcp-connections-per-host-client-and-nat-port-restriction.png)
...
![Mac 下自动分配临时端口范围查看](https://oss.javaguide.cn/github/offerkit/cs-basics/network/check-automatic-temporary-port-range-mac.jpg)
...
![TIME_WAIT 状态占用本地端口并影响可建立连接数](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/how-time-wait-affects-number-of-connections.png)
