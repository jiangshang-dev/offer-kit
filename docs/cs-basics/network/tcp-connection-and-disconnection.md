...
![TCP 四次挥手图解](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-waves-four-times.png)
...
![TCP 连接建立与关闭的常见状态迁移路径](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-state-diagram.png)
