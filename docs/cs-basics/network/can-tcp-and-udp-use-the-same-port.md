...
![端口什么情况下会冲突](https://oss.javaguide.cn/github/offerkit/cs-basics/network/when-does-tcp-conflict-occur.png)
...
![HTTP/3 协议栈实现](https://oss.javaguide.cn/github/offerkit/cs-basics/network/http-3-implementation.png)
