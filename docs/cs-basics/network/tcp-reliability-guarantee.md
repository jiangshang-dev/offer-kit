...
![ARQ 与 TCP 重传机制的关系](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-reliability-guarantee-arq-retransmission-model.png)
...
![RTO 超时时间的计算流程](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-reliability-guarantee-rto-calculation-flow.png)
...
![TCP 零窗口探测机制](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-reliability-guarantee-zero-window-probe.png)
...
![TCP发送窗口结构](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-send-window.png)
...
![TCP接收窗口结构](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-receive-window.png)
...
![SWS、Nagle 算法与延迟 ACK 的关系](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-reliability-guarantee-sws-nagle-delayed-ack.png)
...
![TCP的拥塞控制](https://oss.javaguide.cn/github/offerkit/cs-basics/network/tcp-congestion-control.png)
