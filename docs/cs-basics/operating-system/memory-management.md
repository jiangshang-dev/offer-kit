...
![虚拟地址到物理地址转换](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/memory-address-translation.webp)
...
![多级页表按需创建](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/memory-multilevel-page-table.webp)
