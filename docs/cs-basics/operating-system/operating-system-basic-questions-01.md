...
![Linux 操作系统桌面与命令行界面](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/linux/linux.png)
...
![用户态和内核态](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/usermode-and-kernelmode.png)
...
![用户态切换到内核态的 3 种方式](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/the-way-switch-between-user-mode-and-kernel-mode.drawio.png)
...
![用户程序通过系统调用请求内核服务](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/system-call.png)
...
![系统调用的过程](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/system-call-procedure.png)
...
![程序、进程和线程的关系](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/relationship-between-program-process-and-thread.png)
...
![用微信工厂类比进程和线程的区别](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/wechat-factory-process-thread.png)
...
![线程共享和私有的内容](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/thread-shared-and-private-content.png)
...
![进程状态图转换图](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/state-transition-of-process.png)
...
![fork、exec、wait 的调用链路](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/fork-exec-wait-call-chain.png)
...
![线程上下文切换和进程上下文切换的成本对比](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/context-switch-cost-comparison.png)
...
![常见进程调度算法](https://oss.javaguide.cn/github/offerkit/cs-basics/network/scheduling-algorithms-of-process.png)
