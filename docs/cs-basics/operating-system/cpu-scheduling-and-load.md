...
![CPU 调度取舍关系图](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/scheduler-tradeoff-triangle.webp)
...
![CFS 与 EEVDF 对比图](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/cfs-eevdf-comparison.webp)
...
![load average 与 CPU 使用率对比图](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/load-average-vs-cpu-usage.webp)
...
![CPU 报警排查分支图](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/load-cpu-alert-triage.webp)
