...
![Linux 创始人 Linus Torvalds](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/linux/linux-father.png)
...
![Linux 操作系统 Logo](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/linux/Linux-Logo.png)
...
![Linux 命令快查](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/linux/linux-command-search.png)

另外，[shell.how](https://www.shell.how/) 这个网站可以用来解释常见命令的意思，对你学习 Linux 基本命令以及其他常用命令（如 Git、NPM）。

![shell.how 使用示例](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/linux/shell-now.png)
