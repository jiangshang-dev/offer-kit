...
![内存管理职责概览](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/memory-management-responsibilities.webp)
...
![连续内存分配与碎片](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/memory-fragmentation.webp)
...
![伙伴系统（Buddy System）内存管理](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/linux-buddy-system.png)
...
![伙伴系统内存浪费问题](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/buddy-system-memory-waste.png)
...
![地址翻译过程](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/physical-virtual-address-translation.png)
...
![分段地址转换示意图：虚拟地址由段号和段内偏移组成，通过段表查到基地址后计算物理地址](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-segmentation.png)
...
![分段机制导致外部内存碎片](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/segment-external-memory-fragmentation.png)
...
![单级页表](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/page-table.png)
...
![分页地址转换示意图：虚拟地址拆成页号和页内偏移，页表把虚拟页映射到物理页帧](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-paging.png)
...
![多级页表示意图：PGD、PUD、PMD、PTE 分层索引，只为实际使用的地址范围创建下级页表](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-multi-level-page-table.png)
...
![加入 TLB 之后的地址翻译](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/physical-virtual-address-translation-mmu.png)
...
![TLB 缓存地址转换结果的流程：CPU 先查 TLB，命中直接访问内存，未命中再查多级页表并更新 TLB](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-tlb-cache.png)
...
![缺页异常处理流程：MMU 发现地址翻译或权限检查无法完成后进入内核，检查访问合法性、分配或置换页帧、更新页表并重试指令](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-page-fault.png)
...
![页面置换算法对比](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/memory-page-replacement.webp)
...
![CLOCK 页面置换算法示意图：页面按环形队列排列，指针根据访问位 R 判断给第二次机会还是淘汰页面](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-clock-algorithm.png)
...
![Linux 页面回收思路](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/memory-page-reclaim.webp)
...
![虚拟地址到物理地址的映射过程：不同进程的相同虚拟地址通过 MMU 和页表映射到不同物理页](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/virtual-memory-virtual-physical-mapping.png)
...
![文件系统职责概览](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/file-system-responsibilities.webp)
...
![文件名 dentry 和 inode 关系](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/file-inode-dentry-relation.webp)
...
![路径到文件描述符](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/file-path-to-fd.webp)
...
![文件数据块定位方式](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/file-block-allocation.webp)
...
![硬链接和软链接对比](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/file-hardlink-symlink.webp)
...
![文件写入到持久化路径](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/file-write-persistence.webp)
...
![常见的磁盘调度算法](https://oss.javaguide.cn/github/offerkit/cs-basics/operating-system/disk-scheduling-algorithms.png)
