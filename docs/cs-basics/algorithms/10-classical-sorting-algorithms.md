...
![排序算法分类](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/sort2.png)
...
![冒泡排序](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/bubble_sort.gif)
...
![选择排序每轮选择最小元素放到已排序区末尾](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/selection_sort.gif)
...
![插入排序过程演示](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/insertion_sort.gif)
...
![希尔排序按增量分组并插入排序的过程](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/shell_sort.png)
...
![归并排序递归拆分数组并合并有序子数组](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/merge_sort.gif)
...
![随机快速排序选择基准并递归划分子序列](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/random_quick_sort.gif)
...
![堆排序构建大顶堆并依次取出堆顶元素](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/heap_sort.gif)
...
![计数排序通过统计元素出现次数确定有序位置](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/counting_sort.gif)
...
![桶排序将数据分配到多个桶后分别排序再合并](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/bucket_sort.gif)
...
![基数排序按数字位从低到高依次排序并收集](https://oss.javaguide.cn/github/offerkit/cs-basics/sorting-algorithms/radix_sort.gif)
