...
![布隆过滤器使用的位数组结构](https://oss.javaguide.cn/github/offerkit/cs-basics/algorithms/bloom-filter-bit-table.png)
...
(integer) 1
127.0.0.1:6379> BF.ADD myFilter offerkit
(integer) 1
127.0.0.1:6379> BF.EXISTS myFilter java
(integer) 1
127.0.0.1:6379> BF.EXISTS myFilter offerkit
(integer) 1
