...
![红黑树左倾染色示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/red-black-tree-1.png)
...
![红黑树右倾染色示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/red-black-tree-2.png)

### 3. 左旋调衡

#### 3.1 一次左旋

![红黑树一次左旋调衡示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/red-black-tree-3.png)

#### 3.2 右旋 + 左旋

![红黑树右旋加左旋调衡示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/red-black-tree-4.png)

### 4. 右旋调衡

#### 4.1 一次右旋

![红黑树一次右旋调衡示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/red-black-tree-5.png)

#### 4.2 左旋 + 右旋

![红黑树左旋加右旋调衡示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/red-black-tree-6.png)
