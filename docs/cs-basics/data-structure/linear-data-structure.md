...
![数组](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/array.png)
...
![单链表](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/single-linkedlist.png)

#### 2.2.2. 循环链表

**循环链表** 其实是一种特殊的单链表，和单链表不同的是循环链表的尾结点不是指向 null，而是指向链表的头结点。

![循环链表](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/circular-linkedlist.png)

#### 2.2.3. 双向链表

**双向链表** 包含两个指针，一个 prev 指向前一个节点，一个 next 指向后一个节点。

![双向链表](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/bidirectional-linkedlist.png)

#### 2.2.4. 双向循环链表

**双向循环链表** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![双向循环链表](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/bidirectional-circular-linkedlist.png)
...
![栈的后进先出结构示意图](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/stack.png)
...
![使用两个栈实现浏览器后退和前进功能](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/stack-browser-back-forward.png)
...
![队列](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/queue.png)
...
![顺序队列假溢出](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/seq-queue-false-overflow.png)
...
![循环队列](https://oss.javaguide.cn/github/offerkit/cs-basics/data-structure/circular-queue.png)
