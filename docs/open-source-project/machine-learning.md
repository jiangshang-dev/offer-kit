...
![Spring AI Alibaba 架构](https://oss.javaguide.cn/github/offerkit/open-source-project/ai/springai-alibaba-architecture-new.png)
...
![](https://oss.javaguide.cn/github/offerkit/open-source-project/ai/paiagent-architecture-diagram.jpg)
