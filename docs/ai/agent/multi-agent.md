...
![多 Agent 和多阶段 Prompt Chain 的区别](https://oss.javaguide.cn/github/offerkit/ai/agent/multi-agent-vs-prompt-chain.webp)
...
![多 Agent 固定 DAG 和动态委派的区别](https://oss.javaguide.cn/github/offerkit/ai/agent/multi-agent-static-vs-dynamic-orchestration.webp)
...
![多 Agent 分支失败后的处理策略](https://oss.javaguide.cn/github/offerkit/ai/agent/multi-agent-partial-failure-strategies.webp)
