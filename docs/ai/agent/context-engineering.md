...
![以电商售后为例图解同样的 Agent，为什么表现差这么多](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/why-the-same-agent-performs-so-differently.png)
...
![Prompt engineering vs. context engineering](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/context-engineering-vs-prompt-engineering.png)

打个比方。如果 Prompt Engineering 是“告诉厨师这道菜怎么做”，那 Context Engineering 更像是给厨师准备厨房——食材放在哪、刀具怎么摆、调料怎么分类、火候参考贴在哪里。

![Prompt vs Context 工程维度对比](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/prompt-vs-context-engineering-dimension-comparison.svg)
...
![上下文利用率的 40% 阈值现象](https://oss.javaguide.cn/github/offerkit/ai/harness/context-utilization-40-percent-threshold-phenomenon.svg)
...
![运行时上下文怎么检索](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/context-engineering-run-time-retrieval.png)
...
![长任务上下文持久化：抵抗腐化的三大武器](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/long-task-context-persistence-three-weapons-against-corruption.svg)
...
![ Claude Code 的上下文压缩思路](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/claude-code-context-compression-thinking.png)
...
![Sub-agent 拆分任务，隔离上下文](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/sub-agent-task-splitting-context-isolation%20.png)
...
![上下文工程过程中的系统提示](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/calibrating-the-system-prompt.png)
...
![上下文不是越多越好](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/context-engineering-eviction-strategy.png)
...
![Context Engineering 的核心逻辑](https://oss.javaguide.cn/github/offerkit/ai/context-engineering/context-engineering-core-logic.png)
