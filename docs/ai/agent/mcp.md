...
![MCP 四层架构](https://oss.javaguide.cn/github/offerkit/ai/skills/mcp-four-layer-architecture.png)
...
![MCP 调用时序图](https://oss.javaguide.cn/github/offerkit/ai/skills/mcp-call-seq.png)
...
![MCP 传输方式选择](https://oss.javaguide.cn/github/offerkit/ai/skills/mcp-transport-decision.png)
