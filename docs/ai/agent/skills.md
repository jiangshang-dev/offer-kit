...
![查找自己需要和热门的 Skills](https://oss.javaguide.cn/github/offerkit/ai/skills/skillssh.png)

![Superpowers 内置的 skills](https://oss.javaguide.cn/github/offerkit/ai/skills/superpowers-skills.png)
...
![渐进式披露](https://oss.javaguide.cn/github/offerkit/ai/skills/skills-progressive-disclosure.svg)
...
![Skill 工作流设计](https://oss.javaguide.cn/github/offerkit/ai/skills/agent-skills-workflow-design.webp)
...
![Skill 路由流程](https://oss.javaguide.cn/github/offerkit/ai/skills/agent-skills-routing-flow.webp)
...
![Skill 路由流程](https://oss.javaguide.cn/github/offerkit/ai/skills/skills-router.svg)
