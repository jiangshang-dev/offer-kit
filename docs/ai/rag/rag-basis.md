...
![RAG 示意图](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-index-and-retrieval-explainer.webp)

## 为什么需要 RAG？

![RAG（检索增强生成）如何解决 LLM 的核心挑战](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-llm-challenges.png)
...
![RAG 与传统搜索引擎的区别](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-rag-vs-search-engine.png)
...
![RAG 演进阶段](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-2-evolution-stages.png)
