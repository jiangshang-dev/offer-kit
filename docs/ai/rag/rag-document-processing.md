...
![语义丢失：上下文依赖关系被切碎](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-document-processing-semantic-loss.png)
...
![结构丢失问题：不同格式，坑完全不一样](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-document-processing-structure-loss.png)
...
![分层校验策略：没有质检的管线，不是生产级管线](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-document-processing-hierarchical-verification-strategy.png)
...
![如何从零搭一套企业级文档处理管线？](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-document-processing-build-enterprise-document-processing-pipeline-from-scratch.png)
