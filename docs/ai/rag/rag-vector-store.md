...
![向量索引算法分类](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-vector-index-algorithms-Bjze1jhj.png)
...
![HNSW 索引架构](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-hnsw-architecture.png)
...
![VECTOR 列不能用作任何类型的键，包括主键、外键、唯一键和分区键](https://oss.javaguide.cn/github/offerkit/ai/rag/mysql9-vector-cannot-be-used-as-any-type-of-key.png)
