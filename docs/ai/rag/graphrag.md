...
![什么是 RAG？](https://oss.javaguide.cn/github/offerkit/ai/rag/rag-index-and-retrieval-explainer.webp)
...
![什么是 GraphRAG？](https://oss.javaguide.cn/github/offerkit/ai/rag/graphrag-knowledge-relationship-explainer.webp)
...
![传统向量 RAG 的局限性](https://oss.javaguide.cn/github/offerkit/ai/rag/graphrag-vector-rag-limitation.png)
...
![GraphRAG 和传统向量 RAG 的区别](https://oss.javaguide.cn/github/offerkit/ai/rag/graphrag-vs-rag.png)
...
![GraphRAG 的核心概念](https://oss.javaguide.cn/github/offerkit/ai/rag/graphrag-core-concept.png)
...
![GraphRAG 索引流程](https://oss.javaguide.cn/github/offerkit/ai/rag/graphrag-build-process.png)
...
![GraphRAG 查询阶段：先判断问题类型](https://oss.javaguide.cn/github/offerkit/ai/rag/graphrag-query-routing.png)
