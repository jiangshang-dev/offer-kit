...
![一次 Agent 请求中的信任区](https://oss.javaguide.cn/github/offerkit/ai/llm/llm-security-request-trust-boundaries.webp)
...
![Prompt Injection、间接注入和 Jailbreak 的区别](https://oss.javaguide.cn/github/offerkit/ai/llm/llm-security-prompt-injection-types.webp)
...
![MCP Token 的受众和凭证边界](https://oss.javaguide.cn/github/offerkit/ai/llm/llm-security-mcp-token-boundaries.webp)
...
![高风险工具的安全执行链](https://oss.javaguide.cn/github/offerkit/ai/llm/llm-security-safe-tool-execution-chain.webp)
