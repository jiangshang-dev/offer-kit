...
![AI 可观测信号各自解决的问题](https://oss.javaguide.cn/github/offerkit/ai/llm/ai-observability-signals-overview.webp)
...
![Session、Run、Trace、Span 和 Attempt 的层级关系](https://oss.javaguide.cn/github/offerkit/ai/llm/ai-observability-id-hierarchy.webp)
...
![一次 Agent 请求的 Span 拆分示意图](https://oss.javaguide.cn/github/offerkit/ai/llm/ai-observability-agent-span-trace.webp)
...
![Trace 上下文跨线程、进程和消息边界的传播方式](https://oss.javaguide.cn/github/offerkit/ai/llm/ai-observability-context-propagation.webp)
...
![Trace 头部采样和尾部采样的区别](https://oss.javaguide.cn/github/offerkit/ai/llm/ai-observability-head-tail-sampling.webp)
