...
![Function Calling 完整调用链路：模型生成调用意图，业务侧执行工具](https://oss.javaguide.cn/github/offerkit/ai/llm/structured-output-function-calling-function-calling-pipeline.png)
...
![Eval Harness 从读取评测集到执行评分并进入发布门禁的运行流程](https://oss.javaguide.cn/github/offerkit/ai/llm/llm-evaluation-eval-harness-flow.webp)
