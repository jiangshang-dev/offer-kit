...
> **🐛 修正（参见：[issue#544](https://github.com/jiangshang-dev/offerkit/issues/544)）**：C++11 开始（2011 年的时候），C++ 就引入了多线程库，在 Windows、Linux、macOS 都可以使用 `std::thread` 和 `std::async` 来创建线程。参考链接：<http://www.cplusplus.com/reference/thread/thread/?kw=thread>
...
![运行在 Java 虚拟机之上的编程语言](https://oss.javaguide.cn/github/offerkit/java/basis/java-virtual-machine-program-language-os.png)
...
![](https://oss.javaguide.cn/github/offerkit/java/basis/JavaSeSpecifications.jpg)
...
![jdk-include-jre](https://oss.javaguide.cn/github/offerkit/java/basis/jdk-include-jre.png)
...
![Java程序转变为机器代码的过程](https://oss.javaguide.cn/github/offerkit/java/basis/java-code-to-machine-code.png)
...
![Java程序转变为机器代码的过程](https://oss.javaguide.cn/github/offerkit/java/basis/java-code-to-machine-code-with-jit.png)

> HotSpot 采用了惰性评估(Lazy Evaluation)的做法，根据二八定律，消耗大部分系统资源的只有那一小部分的代码（热点代码），而这也就是 JIT 所需要编译的部分。JVM 会根据代码每次被执行的情况收集信息并相应地做出一些优化，因此执行的次数越多，它的速度就越快。

JDK、JRE、JVM、JIT 这四者的关系如下图所示。

![JDK、JRE、JVM、JIT 这四者的关系](https://oss.javaguide.cn/github/offerkit/java/basis/jdk-jre-jvm-jit.png)

下面这张图是 JVM 的大致结构模型。

![JVM 的大致结构模型](https://oss.javaguide.cn/github/offerkit/java/basis/jvm-rough-structure-model.png)
...
![编译型语言和解释型语言](https://oss.javaguide.cn/github/offerkit/java/basis/compiled-and-interpreted-languages.png)
...
<img src="https://oss.javaguide.cn/github/offerkit/java/basis/jit-vs-aot.png" alt="JIT vs AOT" style="zoom: 25%;" />
...
![oracle jdk release cadence](https://oss.javaguide.cn/github/offerkit/java/basis/oracle-jdk-release-cadence.jpg)
...
![](https://oss.javaguide.cn/github/offerkit/java/basis/image-20220714112336911.png)
...
![](https://oss.javaguide.cn/github/offerkit/up-1ae0425ce8646adfb768b5374951eeb820d.png)
...
![](https://oss.javaguide.cn/github/offerkit/java/basis/java-basis-variables-member-variable-vs-local-variable.png)
...
![](https://oss.javaguide.cn/github/offerkit/java/basis/java-basis-variables-static-variable.png)
...
**方法的重写要遵循“两同两小一大”**（以下内容摘录自《疯狂 Java 讲义》，[issue#892](https://github.com/jiangshang-dev/offerkit/issues/892)）：
