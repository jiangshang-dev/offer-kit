...
![Java 集合框架概览](https://oss.javaguide.cn/github/offerkit/java/collection/java-collection-hierarchy.png)
...
![unlink 方法逻辑](https://oss.javaguide.cn/github/offerkit/java/collection/linkedlist-unlink.jpg)
...
![](https://oss.javaguide.cn/github/offerkit/redisimage-20220412110853807.png)
...
详见笔主的这篇文章: [ArrayList 扩容机制分析](/java/collection/arraylist-source-code.html#arraylist-扩容机制分析)。
...
![](https://oss.javaguide.cn/github/offerkit/java/collection/fail-fast-and-fail-safe-copyonwritearraylist.png)
...
![BlockingQueue](https://oss.javaguide.cn/github/offerkit/java/collection/blocking-queue.png)
