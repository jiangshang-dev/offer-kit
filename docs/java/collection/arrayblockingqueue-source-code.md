...
![ArrayBlockingQueue 类图](https://oss.javaguide.cn/github/offerkit/java/collection/arrayblockingqueue-class-diagram.png)
...
![ArrayBlockingQueue 非空条件](https://oss.javaguide.cn/github/offerkit/java/collection/ArrayBlockingQueue-notEmpty-take.png)
...
![ArrayBlockingQueue 非满条件](https://oss.javaguide.cn/github/offerkit/java/collection/ArrayBlockingQueue-notFull-put.png)
...
![ArrayBlockingQueue 非空非满](https://oss.javaguide.cn/github/offerkit/java/collection/ArrayBlockingQueue-notEmpty-notFull.png)
...
![](https://oss.javaguide.cn/github/offerkit/java/collection/ArrayBlockingQueue-get-add-element-methods.png)
