...
![Buffer 的子类](https://oss.javaguide.cn/github/offerkit/java/nio/buffer-subclasses.png)
...
![position 、limit 和 capacity 之前的关系](https://oss.javaguide.cn/github/offerkit/java/nio/JavaNIOBuffer.png)

![position 、limit 和 capacity 之前的关系](https://oss.javaguide.cn/github/offerkit/java/nio/NIOBufferClassAttributes.png)
...
![capacity、limit和position每一阶段的变化](https://oss.javaguide.cn/github/offerkit/java/nio/NIOBufferClassAttributesDataChanges.png)
...
![Channel 和 Buffer之间的关系](https://oss.javaguide.cn/github/offerkit/java/nio/channel-buffer.png)

另外，部分 Channel（例如 `SocketChannel`）同时支持读写，可以更直接地映射底层操作系统的双向通信能力。

`Channel` 的子类如下图所示。

![Channel 的子类](https://oss.javaguide.cn/github/offerkit/java/nio/channel-subclasses.png)
...
![Channel继承关系图](https://oss.javaguide.cn/github/offerkit/java/nio/channel-inheritance-relationship.png)
