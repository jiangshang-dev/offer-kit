...
> **🐛 修正（参见：[issue#1848](https://github.com/jiangshang-dev/offerkit/issues/1848)）**：对 CPU 缓存模型绘图不严谨的地方进行完善。
...
![缓存一致性协议](https://oss.javaguide.cn/github/offerkit/java/concurrent/cpu-cache-protocol.png)
...
![ JMM 设计思想](https://oss.javaguide.cn/github/offerkit/java/concurrent/jmm-design-idea.png)
...
![jmm-vs-happens-before](https://oss.javaguide.cn/github/offerkit/java/concurrent/jmm-vs-happens-before.png)
