...
![](https://oss.javaguide.cn/github/offerkit/high-performance/serial-to-parallel.png)

对于存在前后调用顺序关系的任务，可以进行任务编排。

![](https://oss.javaguide.cn/github/offerkit/high-performance/serial-to-parallel2.png)
...
![](https://oss.javaguide.cn/offerkit/image-20210902092441434.png)
...
![asyncTool README 文档](https://oss.javaguide.cn/github/offerkit/java/concurrent/asyncTool-readme.png)
