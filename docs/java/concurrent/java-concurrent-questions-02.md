...
![JMM(Java 内存模型)](https://oss.javaguide.cn/github/offerkit/java/concurrent/jmm.png)

![JMM(Java 内存模型)强制在主存中进行读取](https://oss.javaguide.cn/github/offerkit/java/concurrent/jmm2.png)
...
![JUC原子类概览](https://oss.javaguide.cn/github/offerkit/java/JUC%E5%8E%9F%E5%AD%90%E7%B1%BB%E6%A6%82%E8%A7%88-20230814005211968.png)
...
关于 `Unsafe` 类的详细介绍可以看这篇文章：[Java 魔法类 Unsafe 详解 - OfferKit - 2022](/java/basis/unsafe.html)。
...
![synchronized关键字原理](https://oss.javaguide.cn/github/offerkit/java/concurrent/synchronized-principle.png)
...
![执行 monitorenter 获取锁](https://oss.javaguide.cn/github/offerkit/java/concurrent/synchronized-get-lock-code-block.png)

对象锁的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。

![执行 monitorexit 释放锁](https://oss.javaguide.cn/github/offerkit/java/concurrent/synchronized-release-lock-block.png)
...
![synchronized关键字原理](https://oss.javaguide.cn/github/offerkit/synchronized%E5%85%B3%E9%94%AE%E5%AD%97%E5%8E%9F%E7%90%862.png)
...
![](https://oss.javaguide.cn/github/offerkit/java/concurrent/reentrantlock-class-diagram.png)
...
![](https://oss.javaguide.cn/github/offerkit/java/concurrent/reentrantreadwritelock-class-diagram.png)
