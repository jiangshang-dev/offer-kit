...
![QPS、并发数与 RT 的关系](https://oss.javaguide.cn/github/offerkit/high-availability/performance-test-metrics-relation.png)
...
![QPS 与并发数的曲棍球棒曲线](https://oss.javaguide.cn/github/offerkit/high-availability/performance-test-hockey-stick-curve.png)
...
![性能测试分类：压力水位怎么区分](https://oss.javaguide.cn/github/offerkit/high-availability/performance-test-type-boundaries.webp)
...
![全链路压测：先把护栏搭好](https://oss.javaguide.cn/github/offerkit/high-availability/full-link-performance-test-guardrails.webp)
