...
![冗余设计类型](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-redundancy-types.png)
...
![容灾架构对比](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-disaster-recovery-comparison.png)
...
![主备与主主模式](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-ha-cluster-modes.png)
...
![容灾等级光谱](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-dr-level-spectrum.png)
...
![故障转移流程](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-failover-process.png)
...
![Fencing 防脑裂](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-stateful-failover-fencing.png)
...
![Redis 哨兵模式](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-redis-sentinel.png)
...
![Nginx 高可用架构](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-nginx-keepalived.png)

## 异地多活的挑战

异地多活架构实施起来非常难，需要考虑的因素非常多：

![异地多活挑战](https://oss.javaguide.cn/github/offerkit/high-availability/redundancy-optimized-geo-active-active-challenges.png)
