...
![Sentinel：blockHandler 与 Fallback 的区别](https://oss.javaguide.cn/github/offerkit/high-availability/fallback-and-circuit-breaker-blockHandler-vs-Fallback.png)
...
![雪崩效应传播](https://oss.javaguide.cn/github/offerkit/high-availability/fallback-and-circuit-breaker-avalanche-effect-spread.png)
...
![请求保护流程](https://oss.javaguide.cn/github/offerkit/high-availability/fallback-and-circuit-breaker-request-protection-process.png)
...
![隔离策略对比](https://oss.javaguide.cn/github/offerkit/high-availability/fallback-and-circuit-breaker-isolation-strategy-comparison.png)
