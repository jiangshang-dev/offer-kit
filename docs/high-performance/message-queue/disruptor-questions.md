...
![](https://oss.javaguide.cn/github/offerkit/high-performance/message-queue/disruptor-interview-questions.png)
...
![](https://oss.javaguide.cn/github/offerkit/high-performance/message-queue/640.png)
...
![2011 年的 Oracle 官方的 Duke's Choice Awards](https://oss.javaguide.cn/offerkit/image-20211015152323898.png)
...
![disruptor-latency-histogram](https://oss.javaguide.cn/github/offerkit/high-performance/message-queue/disruptor-latency-histogram.png)
...
![LMAX 系统使用 Disruptor 的示例](https://oss.javaguide.cn/github/offerkit/high-performance/message-queue/disruptor-models.png)
...
![Disruptor 等待策略](https://oss.javaguide.cn/github/offerkit/high-performance/message-queue/DisruptorWaitStrategy.png)
...
![CPU 缓存模型示意图](https://oss.javaguide.cn/github/offerkit/java/concurrent/cpu-cache.png)
