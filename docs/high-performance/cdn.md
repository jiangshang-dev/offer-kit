...
![京东仓配系统](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/jingdong-wuliu-cangpei.png)
...
![阿里云文档：https://help.aliyun.com/document_detail/64836.html](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/cdn-aliyun-dcdn.png)
...
![CDN 缓存的完整生命周期](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/cdn-full-life-cycle-of-cdn-cache.png)

如果资源有更新，可以对其进行**刷新**操作，删除 CDN 节点上缓存的旧资源，并强制 CDN 节点在下次请求时回源获取最新资源。

几乎所有云厂商提供的 CDN 服务都具备缓存的刷新和预热功能（下图是阿里云 CDN 服务提供的相应功能）：

![CDN 缓存的刷新和预热](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/cdn-refresh-warm-up.png)
...
![腾讯云 CDN Referer 防盗链配置](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/cnd-tencent-cloud-anti-theft.png)
...
![](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/timestamp-anti-theft.png)

绝大部分 CDN 服务提供商都支持开箱即用的时间戳防盗链机制：

![七牛云时间戳防盗链配置](https://oss.javaguide.cn/github/offerkit/high-performance/cdn/qiniuyun-timestamp-anti-theft.png)
