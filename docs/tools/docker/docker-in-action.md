...
![认识容器](https://oss.javaguide.cn/github/offerkit/tools/docker/container.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/20210412220015698.png)
...
![安装 Docker](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-install-windows.png)

然后点击 `Get Started`：

![安装 Docker](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-install-windows-download.png)
...
![开启 Hyper-V](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-windows-hyperv.png)

点击 `启用或关闭 Windows 功能`：

![开启 Hyper-V](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-windows-hyperv-enable.png)

勾选 `Hyper-V`，点击确定即可：

![开启 Hyper-V](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-windows-hyperv-check.png)

完成更改后需要重启一下计算机。

开启 `Hyper-V` 后，就可以安装 Docker Desktop 了。打开安装程序后，等待片刻点击 `Ok` 即可：

![安装 Docker](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-windows-hyperv-install.png)

安装完成后，我们仍然需要重启计算机，重启后，若提示如下内容：

![安装 Docker](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-windows-hyperv-wsl2.png)
...
![Docker Hub](https://oss.javaguide.cn/github/offerkit/tools/docker/dockerhub-com.png)

在左上角的搜索框中输入 `mysql` 并回车：

![Docker Hub 搜索 MySQL](https://oss.javaguide.cn/github/offerkit/tools/docker/dockerhub-mysql.png)

可以看到相关 MySQL 的镜像非常多，若右上角有 `OFFICIAL IMAGE` 标识，则说明是官方镜像，所以我们点击第一个 MySQL 镜像：

![MySQL 官方镜像](https://oss.javaguide.cn/github/offerkit/tools/docker/dockerhub-mysql-official-image.png)

右边提供了下载 MySQL 镜像的指令为 `docker pull mysql`，但该指令会拉取默认标签对应的版本。实际项目中更建议显式指定版本标签，避免环境不可控。

若是想下载指定版本的镜像，则点击下面的`View Available Tags`：

![查看其他版本的 MySQL](https://oss.javaguide.cn/github/offerkit/tools/docker/dockerhub-mysql-view-available-tags.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-search-mysql-terminal.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-search-mysql-404-terminal.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-ps-terminal.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-run-tomact-8080.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-inspect-terminal.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-data-volume-webapp-8080.png)
...
![](https://oss.javaguide.cn/github/offerkit/tools/docker/docker-data-volume-webapp-8080-hello-world.png)
