...
![](https://oss.javaguide.cn/github/offerkit/database/redis/chrome-clear-cache.png)
...
![本地缓存示意图](https://oss.javaguide.cn/github/offerkit/database/redis/local-cache.png)
...
![分布式缓存](https://oss.javaguide.cn/github/offerkit/database/redis/distributed-cache.png)
...
![多级缓存](https://oss.javaguide.cn/offerkit/database/redis/multilevel-cache.png)
