...
![](https://oss.javaguide.cn/github/offerkit/database/mongodb/sql-nosql-tushi.png)
...
![NoSQL 数据模型](https://oss.javaguide.cn/github/offerkit/database/mongodb/types-of-nosql-datastores.png)
