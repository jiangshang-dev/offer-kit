...
![复合索引](https://oss.javaguide.cn/github/offerkit/database/mongodb/mongodb-composite-index.png)
...
![](https://oss.javaguide.cn/github/offerkit/database/mongodb/replica-set-read-write-operations-primary.png)
...
![](https://oss.javaguide.cn/github/offerkit/database/mongodb/replica-set-primary-with-two-secondaries.png)
...
![](https://oss.javaguide.cn/github/offerkit/database/mongodb/sharded-cluster-production-architecture.png)
...
![](https://oss.javaguide.cn/github/offerkit/database/mongodb/example-of-scope-based-sharding.png)
...
![](https://oss.javaguide.cn/github/offerkit/database/mongodb/example-of-hash-based-sharding.png)
...
![Chunk 分裂](https://oss.javaguide.cn/github/offerkit/database/mongodb/chunk-splitting-shard-a.png)
...
![Chunk 迁移](https://oss.javaguide.cn/github/offerkit/database/mongodb/mongo-reblance-three-shards.png)
