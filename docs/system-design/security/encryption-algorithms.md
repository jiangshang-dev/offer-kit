...
```java
String originalString = "Java学习 + 面试指南：offerkit.cn";
// 创建MD5摘要对象
...
```bash
Original String: Java学习 + 面试指南：offerkit.cn
...
![对称加密](https://oss.javaguide.cn/github/offerkit/system-design/security/encryption-algorithms/symmetric-encryption.png)
...
![DES（Data Encryption Standard）](https://oss.javaguide.cn/github/offerkit/system-design/security/des-steps.jpg)
...
![AES（Advanced Encryption Standard）](https://oss.javaguide.cn/github/offerkit/system-design/security/aes-steps.jpg)
...
![DES 和 AES 对比](https://oss.javaguide.cn/github/offerkit/system-design/security/des-vs-aes.png)
...
AES Decrypted Data : Java学习 + 面试指南：offerkit.cn
```
...
![非对称加密](https://oss.javaguide.cn/github/offerkit/system-design/security/encryption-algorithms/asymmetric-encryption.png)
...
![HTTPS 证书签名算法中带RSA 加密的SHA-256 ](https://oss.javaguide.cn/github/offerkit/system-design/security/encryption-algorithms/https-rsa-sha-256.png)
...
RSA Decrypted Data : Java学习 + 面试指南：offerkit.cn
```
