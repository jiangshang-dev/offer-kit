...
![新权限系统方案](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/new-authority-system-design.png)
...
![系统接入流程图](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/new-authority-system-design-access-flow-chart.png)
...
![系统管理界面设计](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/new-authority-system-management-interface.png)

#### 菜单管理

新权限系统首先对菜单进行了分类，分别是 `目录`、`菜单` 和 `操作`，示意如下图

![菜单管理界面](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/new-authority-system-menu.png)
...
![菜单管理界面设计](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/new-authority-system-menu-management-interface.png)
...
![角色与用户管理模块设计](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/role-and-user-management.png)
...
![权限申请界面](https://oss.javaguide.cn/github/offerkit/system-design/security/design-of-authority-system/permission-application.png)
