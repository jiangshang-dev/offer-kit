...
![浏览器 Trie 树效果展示](https://oss.javaguide.cn/github/offerkit/system-design/security/brower-trie.png)
...
![敏感词 Trie 树](https://oss.javaguide.cn/github/offerkit/system-design/security/sensitive-word-trie.png)
...
![AC 自动机构建与匹配流程](https://oss.javaguide.cn/github/offerkit/system-design/security/sensitive-word-ac-automaton-flow.png)
...
![Hutool 的 DFA 算法](https://oss.javaguide.cn/github/offerkit/system-design/security/hutool-dfa.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/security/sensitive-word-filter-arch.png)
