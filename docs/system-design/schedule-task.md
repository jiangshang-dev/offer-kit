...
![](https://oss.javaguide.cn/offerkit/20210607154324712.png)
...
![BlockingQueue 的实现类](https://oss.javaguide.cn/github/offerkit/java/collection/blocking-queue-hierarchy.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/one-layers-of-time-wheel.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/three-layers-of-time-wheel.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/elasticjob-feature-list.png)

下面是早期 ElasticJob-Lite 以 ZooKeeper 为注册中心的架构图，用于理解其去中心化调度思路；当前版本还支持 etcd，不能把图中的组件当成唯一部署方式。

![ElasticJob-Lite 的架构设计](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/elasticjob-lite-architecture-design.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/xxljob-feature-list.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/xxljob-architecture-design-v2.1.0.png)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/schedule-task/xxljob-admin-task-management.png)
