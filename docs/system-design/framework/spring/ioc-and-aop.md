...
![](https://oss.javaguide.cn/github/offerkit/system-design/framework/spring/martin-fowler-injection.png)
...
![面向切面编程图解](https://oss.javaguide.cn/github/offerkit/system-design/framework/spring/aop-program-execution.jpg)
...
![](https://oss.javaguide.cn/github/offerkit/system-design/framework/spring/crosscut-logic-and-businesslogic-separation%20%20%20%20%20%20.png)
...
public class LogAspect {
  // 切入点，所有被 Log 注解标注的方法
  @Pointcut("@annotation(cn.offerkit.annotation.Log)")
  public void webLog() {
  }
