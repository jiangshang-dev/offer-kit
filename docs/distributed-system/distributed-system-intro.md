...
![分布式系统概览](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/distributed-system-overview.webp)
...
![分片复制与一致性](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/sharding-replication-consistency.webp)
...
![远程调用不确定性](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/remote-call-uncertainty.webp)
