...
![](https://oss.javaguide.cn/github/offerkit/mysql/%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)
...
![数据库事务示意图](https://oss.javaguide.cn/github/offerkit/mysql/%E6%95%B0%E6%8D%AE%E5%BA%93%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)

另外，关系型数据库（例如：`MySQL`、`SQL Server`、`Oracle` 等）事务都有 **ACID** 特性：

![ACID](https://oss.javaguide.cn/github/offerkit/mysql/ACID.png)
...
![AID->C](https://oss.javaguide.cn/github/offerkit/mysql/AID-%3EC.png)
...
![分布式事务示意图](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-with-two-services.png)
...
![分布式事务解决方案总结](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-solution-summary.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/xa-specification-roles.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/2pc-work-flow.png)
...
![2PC示意图-就绪](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-2pc-ready.png)
...
![2PC示意图-未就绪](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-2pc-not-ready.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/3pc-work-flow.png)
...
![3PC示意图-就绪](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-3pc-ready.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-tcc-confirm.png)

出现异常的话，会执行 `try`、`cancel` 方法。

![](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-tcc-cancel.png)
...
![2PC 对比 TCC](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/2pc-vs-tcc.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/distributed-transaction/distributed-transaction-saga.png)
