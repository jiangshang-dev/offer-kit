...
![定时任务执行语义](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/cronjob-execution-semantics.webp)
...
![分布式协调决策与传播](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/distributed-coordination-decision-vs-propagation.webp)
...
![Lease 与 Fencing Token](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/lease-fencing-token-late-write.webp)
...
![分布式协调机制选型](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/distributed-coordination-mechanism-selection.webp)
