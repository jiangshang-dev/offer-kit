...
![拜占庭将军问题的基本场景](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-problem-overview.png)
...
![忠诚节点多数决示意](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-honest-majority.png)
...
![三个将军无法容忍一个叛徒](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-three-general-impossibility.png)
...
![共识协议中的安全性与活性](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-safety-liveness.png)
...
![口信消息模型 OM(m) 的多轮转述](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-oral-messages.png)
...
![签名消息模型 SM(m) 的信息传播](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-signed-messages.png)
...
![崩溃故障、遗漏时序故障和拜占庭故障](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-fault-models.png)
...
![CFT、BFT 和签名消息模型对比](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-cft-vs-bft.png)
...
![区块链里的阈值](https://oss.javaguide.cn/github/offerkit/system-design/distributed-system/byzantine-generals-problem-blockchain-weight-thresholds.png)
