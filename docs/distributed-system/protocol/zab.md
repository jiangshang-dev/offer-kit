...
![ZXID 结构](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/zab-zxid-structure.png)
...
![ZAB 消息广播模式](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/zab-message-broadcast-flow.png)
...
![zab-crash-recovery-flow](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/zab-crash-recovery-flow.png)
