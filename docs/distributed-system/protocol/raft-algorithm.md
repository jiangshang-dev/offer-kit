...
![共识算法架构](https://oss.javaguide.cn/github/offerkit/paxos-rsm-architecture.png)
...
![Raft 服务器状态转换示意图](https://oss.javaguide.cn/github/offerkit/paxos-server-state.png)

### 2.2 任期

![任期（term）示意图](https://oss.javaguide.cn/github/offerkit/paxos-term.png)
...
![Raft 任期逻辑演进 (Term Progression)](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/raft-term-progression.png)
...
![Raft Leader 选举流程](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/raft-election.png)
