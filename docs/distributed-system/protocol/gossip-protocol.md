...
![Gossip 翻译](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/gossip.png)
...
![Redis 的官方集群解决方案](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/up-fcacc1eefca6e51354a5f1fc9f2919f51ec.png)
...
![Redis Cluster  各个节点之间使用 Gossip 进行通信](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/redis-cluster-gossip.png)
...
![反熵机制：Push-Pull 交互时序图 (Anti-Entropy)](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/gossip-anti-entropy-pushpull.png)

伪代码如下：

![反熵伪代码](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/up-df16e98bf71e872a7e1f01ca31cee93d77b.png)
...
![确定性闭环调度](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/raft-anti-entropyclosed-loop.png)
...
![Gossip 传播示意图](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/gossip-rumor-mongering.gif)

伪代码如下：

![](https://oss.javaguide.cn/github/offerkit/csdn/20210605170707933.png)
...
![Gossip 协议：随机传播与收敛过程](https://oss.javaguide.cn/github/offerkit/distributed-system/protocol/gossip-propagation.png)
