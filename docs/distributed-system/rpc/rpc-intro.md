...
![RPC 原理图](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/rpc-principle.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/image-20220716111053081.png)
...
![Dubbo3](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/image-20220716111545343.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/2843b10d-0c2f-4b7e-9c3e-ea4466792a8b.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/image-20220716104304033.png)
...
![](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/eee98ff2-8e06-4628-a42b-d30ffcd2831e.png)

Dubbo 也是 Spring Cloud Alibaba 里面的一个组件。

![](https://oss.javaguide.cn/github/offerkit/distributed-system/rpc/0d195dae-72bc-4956-8451-3eaf6dd11cbd.png)
...
**《手写 RPC 框架》** 是我的[知识星球](/about-the-author/zhishixingqiu-two-years.html)的一个内部小册，我写了 12 篇文章来讲解如何从零开始基于 Netty+Kyro+Zookeeper 实现一个简易的 RPC 框架。

麻雀虽小五脏俱全，项目代码注释详细，结构清晰，并且集成了 Check Style 规范代码结构，非常适合阅读和学习。

**内容概览**：

![](https://oss.javaguide.cn/github/offerkit/image-20220308100605485.png)
